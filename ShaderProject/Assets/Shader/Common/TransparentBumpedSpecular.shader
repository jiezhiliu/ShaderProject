...
Shader "MyShader/TransparentBumpedSpecular"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float3 worldTangent = normalize(mul((float3x3)unity_WorldToObject, v.tangent.xyz));
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 specular = _LightColor0.rgb * _SpecularColor * pow(saturate(dot(tangentNormal, halfDir)), _Gloss);

                UNITY_LIGHT_ATTENUATION(atten, i, worldPos);
                return fixed4(ambient + (diffuse + specular) * atten, texColor.a * _Color.a);
            }
            ENDCG
        }
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                UNITY_LIGHT_ATTENUATION(atten, i, worldPos);
                return fixed4((diffuse + specular) * atten, texColor.a * _Color.a);
            }
            ENDCG
        }
    }
